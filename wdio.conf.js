...
exports.config = {
    ...
    //     args: ['--use-fake-ui-for-media-stream','--use-fake-device-for-media-stream ', '--disable-gpu', '--window-size=1920,1080']
    // },
    capabilities: {
        Host: {
            capabilities: {
    ...
    cucumberOpts: {
        ...
        require: ['./test/step-definitions/given.js', './test/step-definitions/when.js', './test/step-definitions/then.js'],
